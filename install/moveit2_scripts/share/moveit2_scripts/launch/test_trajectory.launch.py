...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "description_file",
            default_value="welding_robot.urdf.xacro",
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "moveit_config_file",
            default_value="welding_robot.srdf.xacro",
    ...
    srdf_file = load_file("Robot_ver2", "config/welding_robot.srdf")
