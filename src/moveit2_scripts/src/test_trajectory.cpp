...
// Getting Basic Information
  ...
  void current_state() {
    RCLCPP_INFO(LOGGER, "Get Robot Current State");
        current_state_arm = move_group_arm.getCurrentState(20);
    ...
    joint_group_positions_arm[0] = 1.00;  // Shoulder Pan
    joint_group_positions_arm[1] = -1;  // Shoulder Lift
    joint_group_positions_arm[2] = 0.50;  // Elbow
